...
public class GDMTO extends javax.swing.JFrame {
    ...
    public void obtenerCargoDistribucion(){
        double consumo = Double.parseDouble(Consumo.getText());
        int diasPeriodo = Integer.parseInt(ResDiasPeriodo.getText());
        double res = c.CargoDistribucion(consumo, diasPeriodo, fc);
    ...
    public void obtenerCostos(){
        ...
        String sql = "SELECT * FROM GDMTO WHERE ANIO = '" + anioFin + "' AND mes = '"  + mes[mesFin] +"'";
        Statement st;
    ...
    public void obtenerResTransmision(){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cálculo de Tarifa: GDMTO");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2), "Desglose de Facturacion Trarifa GDMTO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
    ...
    private void CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcularActionPerformed
        ...
        /*Este boton llama todas las funciones para hacer el calculo*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GDMTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
